...
public class FileEditor {
    public String Loader() throws IOException {
        BufferedReader inputStream = new BufferedReader(new FileReader("/Users/codecadet/Documents/bolas/core/assets/highscores.txt")); //nao consigo passar file
        String  totalLines = "";
    ...
    public void Writer(String playerName, String value)throws IOException{
        ...
        BufferedWriter outputStream = new BufferedWriter(new FileWriter("/Users/codecadet/Documents/bolas/core/assets/highscores.txt"));
